...
urlpatterns = [
    ...
    path('single_product/<int:pro_id>/', views.single_product, name="single_product"),path('signin_signup/',views.signin_signup,name="signin_signup"),
    ...
    path('save_billing_data/',views.save_billing_data,name='save_billing_data'),
